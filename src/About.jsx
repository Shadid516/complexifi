...
function About() {
  return (
    <div className="container">
      ...
      Complexifi is a resource platform with a complementary VSCode extension to encourage developer.
      </p>
      <p className="text-center">
      ...
      <p className="text-center">
        ...
        <span class= "name">
          ...
          <a href="https://www.linkedin.com/in/shadi-al-masry-489458165/" target="_blank" rel="noopener noreferrer">Shadi Al Masri</a>,
        </span>
